    ...
    <div className="about-main">
      <div className="about-body">
        ...
        <p>
          ...
          <p>Having decided I wanted a new challenge and to
          redirect my career, I enrolled at Ironhack
          Paris to begin my Web Development journey. During this 10-week intensive boot camp I focused on
          MERN Full-Stack development, completing three projects to test and build
          skills. These included a video game using Javascript/HTML/CSS, a Full-Stack
          web application with NodeJS and MondgoDB and a single page Full-Stack application
          using ReactJS. 
          </p>
        ...
        <p className="about-technologies">JavaScript | ReactJs | NodeJs | ExpressJs | MongoDB | HTML | CSS | Axios | Mongoose | Git |</p>
      </div>
    </div>
  );
};
